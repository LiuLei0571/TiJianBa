...
public class MenuFamilyAdapter extends BaseListAdapter<Menu> {
  ...
  public MenuFamilyAdapter(Context context, ArrayList<Menu> list) {
    super(context, list, R.layout.menu_family_item);
  ...
  public View getView(final int pos, View view, ViewGroup arg2) {
    ...
    if (view == null) {
      ...
      view = LayoutInflater.from(mContext).inflate(R.layout.menu_family_item, null);
      ...
      holder.mMenuOrgPlatformPricePriceTextView = (TextView) view.findViewById(R.id.tv_menu_price_plat);
    ...
    try {
      ...
      holder.mMenuOrgPriceTextView.setText(item.getFamilyPrice() + "");
      holder.mMenuOrgMarketPriceTextView.setText(item.getMarketPrice() + "");
      holder.mMenuOrgPlatformPricePriceTextView.setText(item.getPlatformPrice() + "");
      if (item.getRebate() != 0) {
  ...
  class ViewHolder {
    ...
    void initHolder(View view) {
      ...
      mMenuOrgPlatformPricePriceTextView = (TextView) view.findViewById(R.id.tv_menu_price_plat);
