...
public class LineDataSet extends LineRadarDataSet<Entry> {
  ...
  /**
   * Sets the intensity for cubic lines (if enabled). Max = 1f = very cubic, Min
   * = 0.05f = low cubic effect, Default: 0.2f
   * 
   * @param intensity
   */
  ...
  /**
   * sets the size (radius) of the circle shpaed value indicators, default size
   * = 4f
   * 
   * @param size
   */
  ...
  /**
   * Sets the colors that should be used for the circles of this DataSet. Colors
   * are reused as soon as the number of Entries the DataSet represents is
   * higher than the size of the colors array. Make sure that the colors are
   * already prepared (by calling getResources().getColor(...)) before adding
   * them to the DataSet.
   * 
   * @param colors
   */
  ...
  /**
   * ets the colors that should be used for the circles of this DataSet. Colors
   * are reused as soon as the number of Entries the DataSet represents is
   * higher than the size of the colors array. You can use
